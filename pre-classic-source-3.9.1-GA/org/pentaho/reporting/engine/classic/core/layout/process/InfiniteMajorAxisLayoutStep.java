...
public final class InfiniteMajorAxisLayoutStep extends IterateVisualProcessStep
{
  ...
  protected boolean startBlockLevelBox(final RenderBox box)
  {
    ...
    else if (nodeType == LayoutNodeTypes.TYPE_BOX_WATERMARK)
    {
  ...
  protected void finishBlockLevelBox(final RenderBox box)
  {
    ...
    if (type == LayoutNodeTypes.TYPE_BOX_WATERMARK)
    {
      final WatermarkAreaBox watermarkAreaBox = (WatermarkAreaBox) box;
      box.setCachedHeight(watermarkAreaBox.getLogicalPage().getPageHeight());
    }
    else
    {
      ...
      else if ((type & LayoutNodeTypes.MASK_BOX_BLOCK) == LayoutNodeTypes.MASK_BOX_BLOCK)
      {
  ...
  private long computeVerticalBlockPosition(final RenderNode node)
  {
    ...
    if (parent != null &&
        ((parent.getNodeType() & LayoutNodeTypes.MASK_BOX_BLOCK) == LayoutNodeTypes.MASK_BOX_BLOCK))
    {
