...
public final class RevalidateAllAxisLayoutStep extends IterateVisualProcessStep
{
  ...
  protected void processParagraphChilds(final ParagraphRenderBox paragraph)
  {
    ...
    final ElementAlignment lastLineAlignment = paragraph.getLastLineAlignment();
    final ElementAlignment elementAlignment = paragraph.getTextAlignment();
    if (lastLineAlignment == elementAlignment)
    {
    ...
    while (node != null)
    {
      ...
      if (inlineRenderBox != lastLine &&
          y + height <= paragraphBottom)
      {
      ...
      final ParagraphPoolBox mergedLine;
      ...
      // Merge it with the previous line-paragraph.
        mergedLine = rebuildLastLine(prev, inlineRenderBox);
      ...
      final LastLineTextAlignmentProcessor proc = create(lastLineAlignment);
